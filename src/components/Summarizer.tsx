      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-border pb-6 sm:pb-8 gap-4">
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div className="space-y-0.5 sm:space-y-1">
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-foreground font-serif">Summary</h2>
            <p className="text-[8px] sm:text-[10px] uppercase font-bold tracking-[0.25em] text-muted-foreground">Generated by AI from your paper</p>
          </div>
        </div>
        <div className="text-left sm:text-right">
           <span className="px-2.5 sm:px-3 py-1 bg-accent-soft text-accent-ink dark:text-accent-ink text-[8px] sm:text-[10px] font-bold rounded-full border border-accent/30">From your paper</span>
        </div>
      </div>
